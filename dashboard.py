...
if not df.empty:
    ...
    fig = px.treemap(
        ...
        custom_data=["return_str", "평가금액", "수익금", "평단가", "현재가"],
    )
    ...
    # coloraxis_showscale=False 옵션을 추가하여 오른쪽 긴 범례 바를 제거합니다.
    fig.update_layout(
